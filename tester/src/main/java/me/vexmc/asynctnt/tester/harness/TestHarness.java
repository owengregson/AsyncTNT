...
public final class TestHarness {
    ...
    public TestHarness(@NotNull JavaPlugin plugin, @NotNull Scheduling scheduling) {
        this.plugin = plugin;
        this.scheduling = scheduling;
    }

    public void run(@NotNull List<TestCase> suite) {
            ...
            for (TestCase test : suite) {
                ...
                try {
                    ...
                    for (StackTraceElement frame : failure.getStackTrace()) {
                        if (frame.getClassName().startsWith("me.vexmc.asynctnt")) {
